...
#ifndef _cxx_abstract_frame_hpp_
#define _cxx_abstract_frame_hpp_
...
namespace abstract {
  ...
  //! Generic interface for frames.
  template<bool resizeable = false> 
    class frame : public view<resizeable>
  {
  };

} // end of namespace abstract
#endif // _cxx_abstract_frame_hpp_
