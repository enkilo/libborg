#ifndef BORG_AST_COMPOUND_HPP
#define BORG_AST_COMPOUND_HPP
...
//---------------------------------------------------------------------------
#define BORG_AST_COMPOUND_TYPES(Traits) \
...
public:
  ...
  BORG_AST_COMPOUND_TYPES(typename impl)
           ...
           const borg::ast::compound_t<AstTraits> &compound)
{
  ...
  BOOST_AUTO(itb, compound.children.begin());
  BOOST_AUTO(ite, compound.children.end());
...
//---------------------------------------------------------------------------
#endif //ndef BORG_AST_COMPOUND_HPP
