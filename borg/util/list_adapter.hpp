#ifndef LIST_ADAPTER_HPP
#define LIST_ADAPTER_HPP
...
public:
  ...
  typedef array_adapter<Derived, value, base, inherit> this_type;
...
operator<<(std::basic_ostream<charT, traits> &os, 
           const borg::array_adapter<Derived, value, base, inherit> &a)
{
  os << a.join(',');
  return os;
}
