#ifndef BORG_WRAP_REFERENCE_FACADE_HPP
#define BORG_WRAP_REFERENCE_FACADE_HPP
...
struct reference_facade
{
  ...
  //! \name Concept checks.
  //@{
  //BOOST_STATIC_ASSERT(boost::is_reference<value_type>::value);
//  BOOST_CLASS_REQUIRE3(Derived, value_type, wrap_type, wrap, WrapperCoreConcept);
  //@}
  
  typedef typename boost::remove_reference<value_type>::type pointee_type;
...
//----------------------------------------------------------------------------
#endif //ndef BORG_WRAP_REFERENCE_FACADE_HPP
