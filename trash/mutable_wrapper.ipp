...
//----------------------------------------------------------------------------
//! \file wrap/mutable_wrapper.ipp
//! \svn  $Revision: $
//!
//! Declares the abstract::mutable_wrapper interface.
//----------------------------------------------------------------------------

#ifndef MUTABLE_WRAPPER_IPP
#define MUTABLE_WRAPPER_IPP
...
//----------------------------------------------------------------------------
#include <wrap/wrapper.ipp>
#include <wrap/mutable_const_wrapper.ipp>

//----------------------------------------------------------------------------
//! \name mutable_wrapper interface:
//----------------------------------------------------------------------------
//@{
...
//----------------------------------------------------------------------------
#undef MUTABLE_WRAPPER_IPP
#endif // MUTABLE_WRAPPER_IPP
